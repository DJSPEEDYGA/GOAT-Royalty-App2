...
// SECURITY NOTE: Set NEXT_PUBLIC_SUPABASE_ANON_KEY in .env.local for production
// The fallback key below is the public anon key (read-only, safe to expose in client code)
// It is NOT a secret — Supabase anon keys are designed to be public (RLS enforces security)
const supabaseUrl = process.env.NEXT_PUBLIC_SUPABASE_URL || 'https://xmvlnonsxmrpvlssjstl.supabase.co'
