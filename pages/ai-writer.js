...
export default function AIWriterPage() {
  ...
  return (
    <>
      <Head><title>AI Writer | Super GOAT Royalty App</title></Head>
        ...
        <header className="flex items-center justify-between px-4 py-2 bg-black/50 border-b border-gray-800/50">
          <div className="flex items-center gap-3">
            ...
            <div className="flex items-center gap-2">
              ...
              <div>
                <h1 className="text-sm font-bold text-white leading-none">AI Writer</h1>
                <p className="text-[9px] text-gray-500">Professional content creation</p>
              </div>
            </div>
          </div>
        </header>
        <div className="flex-1 overflow-hidden"><AIWriter /></div>
      </div>
    </>
  );
}